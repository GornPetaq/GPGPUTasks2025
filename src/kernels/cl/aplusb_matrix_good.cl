                     ...
                     unsigned int height)
{
    ...
    // Вместо счета, выровненного по width * j, и считающего исключительно внутри одной строки, считаем выровненно по размеру группы, что дает рост на моей машине с 32 ГБ/с до 166 ГБ/с
 }
